...
function drop(e) {
  ...
  listColumn.forEach(coulumn => {
    coulumn.classList.remove('over')
  }) ; 
  //add item to column 
  const patent = listColumn[currentColumn] ; 
  patent.appendChild(draggedItem); 
